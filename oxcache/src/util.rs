...
macro_rules! log_async_write_lock {
    ($lock:expr) => {{
        println!("[{}, {}] Trying to write lock {}", file!(), line!(), stringify!($lock));
...
macro_rules! log_async_mutex_lock {
    ($lock:expr) => {{
        println!("[{}, {}] Trying to lock {}", file!(), line!(), stringify!($lock));
...
macro_rules! log_async_read_lock {
    ($lock:expr) => {{
        println!("[{}, {}] Trying to read lock {}", file!(), line!(), stringify!($lock));
