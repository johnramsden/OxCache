...
1. [`populate.py`](../eval/remotetransfer/populate.py)
2. [`pulltest.py`](../eval/remotetransfer/pulltest.py)
...
| Metric                | Seconds    | Microseconds |
|-----------------------|------------|--------------|
| Mean latency          | 0.1278   | 127835       |
| Geometric mean latency| 0.1272   | 127221       |
| Minimum latency       | 0.1131   | 113100       |
| Maximum latency       | 0.2670   | 266957       |
| Standard deviation    | 0.0155   | 15502       |
